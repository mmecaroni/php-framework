  ...
  <div class="rounded-lg shadow-md bg-white p-3">
    ...
    <section class="container mx-auto p-4">
      ...
      <a
        ...
        class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200">Apply Now</a>
    </section>
